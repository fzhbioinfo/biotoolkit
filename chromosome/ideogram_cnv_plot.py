...
class Ideogram:
    ...
    def run(cls, args):
        ...
        # ratio格式处理
        ratio = pd.read_csv(args.ratio, sep='\t')
...
def main():
    ...
    parser.add_argument('-ymin', help='y min', default=0, type=int)
    parser.add_argument('-ymax', help='y max', default=4, type=int)
    parser.add_argument('-ratio', help='copy ratio file', required=True)
